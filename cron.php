...
// mike changed 3600(1hr) to 90(1.5 min) to get the q empty - as nothing should run an hour
...
// send test debug email to mike / pnp addition
		mail('nekbet@gmail.com','queue is running',$config['last_queue_run']);
...
mail ('nekbet@gmail.com','test tidy_cache','this runs inside the tidy_cache');
			$cache->tidy();
